...
[![=](https://skillicons.dev/icons?i=js,node,express,sequelize,sqlite,react,tailwind,docker)](https://skillicons.dev)

My guiding star is - make it simple, efficient, and friendly 🌟

Besides, I like to draw in HTML canvas.

In future, I would like to write mobile applications using React Native & Expo.
